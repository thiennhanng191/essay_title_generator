...
# 
# This notebook includes code to build the inference model for model 2 (model with stacked Bi-LSTM encoder and LSTM decoder with Bahdanau Attention), as well as to generate predicted title from a given essay
# 
