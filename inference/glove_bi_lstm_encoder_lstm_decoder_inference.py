# %% [markdown]
# Nhan Nguyen - CMPU366 Spring 2021
# 
# This notebook includes code to build the inference model for model 3 (model with stacked Bi-LSTM encoder and LSTM decoder with Bahdanau Attention using GloVe embeddings), as well as to generate predicted title from a given essay
# 
